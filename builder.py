...
class BareboneBuilder:
    ...
    def build_kernel(self):
        ...
        fff=f'pcc -c -I./file -L./file -nostdlib "$1" -o /tmp/kernel.o'.replace("$1",filename)
        
        self.execute_command(fff,True)
        
        self.execute_command("ld -nostdlib -T  ./file/link.ld /tmp/boot.o /tmp/kernel.o  -o /tmp/hello.elf",True)
